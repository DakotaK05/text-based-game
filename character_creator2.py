...
character_classes = {
    "Warrior": {"max_health": 350, "current_health": 350, "max_mana": 80, "current_mana": 80,
                ...
                "faith": 5, "luck": 10, "willpower": 3, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
    ...
    "Samurai": {"max_health": 200, "current_health": 200, "max_mana": 100, "current_mana": 100, 
                ...
                "faith": 15, "luck": 13, "willpower": 3, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
    ...
    "Rogue": {"max_health": 90, "current_health": 90, "max_mana": 100, "current_mana": 100, 
              ...
              "faith": 0, "luck": 22, "willpower": 3, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
    ...
    "Mage": {"max_health": 80, "current_health": 80, "max_mana": 100, "current_mana": 100, 
             ...
             "faith": 5, "luck": 10, "willpower": 5, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
    ...
    "Archer": {"max_health": 120, "current_health": 120, "max_mana": 120, "current_mana": 120, 
               ...
               "faith": 8, "luck": 22, "willpower": 3, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
    ...
    "Martial Artist": {"max_health": 250, "current_health": 250, "max_mana": 150, "current_mana": 150, 
                       ...
                       "faith": 15, "luck": 10, "willpower": 3, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
    ...
    "Paladin": {"max_health": 400, "current_health": 400, "max_mana": 200, "current_mana": 200, 
                ...
                "faith": 20, "luck": 9, "willpower": 3, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
    ...
    "John Darksoul": {"max_health": 1, "current_health": 1, "max_mana": 0, "current_mana": 0, 
                      ...
                      "faith": -100, "luck": -100, "willpower": 1, "poison_resistance": 200, "cursed_resistance": 300, "bleed_resistance": 300},
}
...
def give_starting_items(player):
    if player.character_class == "Warrior":
        player.add_melee_weapon(it.Melee_Weapon("Greatsword", "Greatsword", 60, bt.Ailments.Item_Ailments(None, 0, 0)))
        player.add_healing_items(it.Healing_Items("Health Potion", 90, 3))
    elif player.character_class == "Rogue":
        player.add_melee_weapon(it.Melee_Weapon("Dagger", "Dagger", 35, bt.Ailments.Item_Ailments("Bleed", 50)))
        player.add_ranged_weapon(it.Ranged_Weapon("Bow", "Bow", 25))
        player.add_ranged_ammo(it.Ranged_Ammo("Basic Iron Tipped Arrow", 30, 99, bt.Ailments.Item_Ailments(None, 0)))
        player.add_healing_items(it.Healing_Items("Health Potion", 90, 3))
    elif player.character_class == "Mage":
        player.add_melee_weapon(it.Melee_Weapon("Dagger", "Dagger", 35, bt.Ailments.Item_Ailments("Bleed", 50)))
        player.add_magic_catalyst(it.Magic_Catalyst("Staff", 15))
        player.add_combat_spell(it.Combat_Spell("Magic Dart", 30, 10, 15, bt.Ailments.Item_Ailments(None, 0) ))
        player.add_healing_items(it.Healing_Items("Health Potion", 90, 3))
    elif player.character_class == "Samurai":
        player.add_melee_weapon(it.Melee_Weapon("Katana", "Katana", 50, bt.Ailments.Item_Ailments("Bleed", 80)))
        player.add_ranged_weapon(it.Ranged_Weapon("Bow", "Bow", 25))
        player.add_ranged_ammo(it.Ranged_Ammo("Basic Iron Tipped Arrow", 30, 99, bt.Ailments.Item_Ailments(None, 0) ))
        player.add_healing_items(it.Healing_Items("Health Potion", 90, 3))
        ...
        player.add_melee_weapon(it.Melee_Weapon("Bandages", "Gauntlet", 30, bt.Ailments.Item_Ailments(None, 0) ))
        player.add_healing_items(it.Healing_Items("Health Potion", 90, 3))
    elif player.character_class == "Paladin":
        player.add_melee_weapon(it.Melee_Weapon("Holy GreatSword", "Greatsword", 90, bt.Ailments.Item_Ailments(None, 0) ))
        player.add_prayer_catalyst(it.Prayer_Catalyst("Cross", 15))
        player.add_healing_prayers(it.Healing_Prayers("Heal", 80, 20, 15))
        player.add_combat_prayers(it.Combat_Prayers("Lightning Shot", 60, 20, 15, bt.Ailments.Item_Ailments(None, 0) ))
        player.add_healing_items(it.Healing_Items("Health Potion", 90, 3))
